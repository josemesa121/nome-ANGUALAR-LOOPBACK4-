...
export class AccountApi extends BaseLoopBackApi {
  ...
  /**
   * Buscar un elemento relacionado por id para workouts.
   *
   * @param {any} id Account id
   *
   * @param {any} fk Clave foránea para workouts
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdWorkouts(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Suprimir un elemento relacionado por id para workouts.
   *
   * @param {any} id Account id
   *
   * @param {any} fk Clave foránea para workouts
   ...
   * This method returns no data.
   */
  public destroyByIdWorkouts(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts/:fk";
    let _routeParams: any = {
  ...
  /**
   * Actualizar un elemento relacionado por id para workouts.
   *
   * @param {any} id Account id
   *
   * @param {any} fk Clave foránea para workouts
   ...
   * </em>
   */
  public updateByIdWorkouts(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts/:fk";
    let _routeParams: any = {
  ...
  /**
   * accessTokens consultas de Account.
   *
   * @param {any} id Account id
   *
   * @param {object} filter 
  ...
  /**
   * Recuentos accessTokens de Account.
   *
   * @param {any} id Account id
   *
   ...
   * </em>
   */
  public getWorkouts(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Crea una nueva instancia en workouts de este modelo.
   *
   * @param {any} id Account id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createWorkouts(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts";
    let _routeParams: any = {
  ...
  /**
   * Suprime todos los workouts de este modelo.
   *
   * @param {any} id Account id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteWorkouts(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countWorkouts(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Buscar un elemento relacionado por id para sets.
   *
   * @param {any} id Account id
   *
   * @param {any} nk Clave foránea para workouts.
   *
   * @param {any} fk Clave foránea para sets
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdWorkoutsSets(id: any, nk: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts/:nk/sets/:fk";
    let _routeParams: any = {
      id: id,
      nk: nk,
      fk: fk
  ...
  /**
   * Suprimir un elemento relacionado por id para sets.
   *
   * @param {any} id Account id
   *
   * @param {any} nk Clave foránea para workouts.
   ...
   * This method returns no data.
   */
  public destroyByIdWorkoutsSets(id: any, nk: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts/:nk/sets/:fk";
    let _routeParams: any = {
  ...
  /**
   * Actualizar un elemento relacionado por id para sets.
   *
   * @param {any} id Account id
   *
   * @param {any} nk Clave foránea para workouts.
   ...
   * </em>
   */
  public updateByIdWorkoutsSets(id: any, nk: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts/:nk/sets/:fk";
    let _routeParams: any = {
  ...
  /**
   * Capta la relación belongsTo account.
   *
   * @param {any} id Account id
   *
   * @param {any} nk Clave foránea para workouts.
   ...
   * </em>
   */
  public getWorkoutsAccount(id: any, nk: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts/:nk/account";
    let _routeParams: any = {
      id: id,
      nk: nk
    };
   ...
   * </em>
   */
  public getWorkoutsSets(id: any, nk: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts/:nk/sets";
    let _routeParams: any = {
      id: id,
      nk: nk
    };
  ...
  /**
   * Crea una nueva instancia en sets de este modelo.
   *
   * @param {any} id Account id
   *
   * @param {any} nk Clave foránea para workouts.
   ...
   * </em>
   */
  public createWorkoutsSets(id: any, nk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts/:nk/sets";
    let _routeParams: any = {
  ...
  /**
   * Suprime todos los sets de este modelo.
   *
   * @param {any} id Account id
   *
   * @param {any} nk Clave foránea para workouts.
   ...
   * This method returns no data.
   */
  public deleteWorkoutsSets(id: any, nk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts/:nk/sets";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countWorkoutsSets(id: any, nk: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts/:nk/sets/count";
    let _routeParams: any = {
      id: id,
      nk: nk
    };
   ...
   * Data properties:
   *
   *  - `account` – `{function Account(data, options) {
        if (!(this instanceof Account)) {
          return new Account(data, options);
        }
        if (Account.settings.unresolved) {
          throw new Error(g.f('Model %s is not defined.', "Account"));
        }
        ModelBaseClass.apply(this, arguments);
      }}` - 
   */
  public register(firstName: any = {}, lastName: any = {}, email: any = {}, password: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/register";
    let _routeParams: any = {};
   ...
   * </em>
   */
  public createManyWorkouts(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyWorkoutsSets(id: any, nk: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Accounts/:id/workouts/:nk/sets";
    let _routeParams: any = {
